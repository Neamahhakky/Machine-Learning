...
[JJ1 theta1]=Logistic_Regression(H1,Train_y,X1,theta1);
%TEST--------------------------------------------------------
...
[JJ2 theta2]=Logistic_Regression(H2,Train_y,X2,theta2);
%TEST----------------------------------------------------------
...
[JJ3 theta3]=Logistic_Regression(H3,Train_y,X3,theta3);
% %TEST----------------------------------------------------------
...
[JJ4 theta4]=Logistic_Regression(H4,Train_y,X4,theta4);
%TEST----------------------------------------------------------
